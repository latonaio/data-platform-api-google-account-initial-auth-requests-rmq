...
func (c *DPFMAPICaller) AsyncRequests(
	...
	for _, fn := range accepter {
		switch fn {
		case "GoogleAccountInitialAuth":
			googleAccountInitialAuth = c.GoogleAccountInitialAuth(input, &errs, log, c.conf)
		default:
		}
	}

	data := &dpfm_api_output_formatter.Message{
		GoogleAccountInitialAuth: googleAccountInitialAuth,
	}
